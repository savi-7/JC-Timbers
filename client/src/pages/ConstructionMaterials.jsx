    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <>
            {products.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No Construction Materials Available</h3>
                <p className="text-gray-500">Check back later for new construction materials.</p>
              </div>
            )}
          </>
        )}
        ...
        <div className="mt-16 bg-blue-600 rounded-lg p-8 text-center text-white">
          <h3 className="text-2xl font-bold mb-4">Need Help Finding Construction Materials?</h3>
